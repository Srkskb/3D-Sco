...
export default function PAccountStack() {
  return (
    <Stack.Navigator screenOptions={{ headerShown: false }}>
      ...
      <Stack.Screen name="ParentAddFileCabinet" component={ParentAddFileCabinet} />
      <Stack.Screen name="ParentViewContent" component={ParentViewContent} />
      <Stack.Screen name="ParentEditFileCabinet" component={ParentEditFileCabinet} />
      <Stack.Screen name="ParentLibrary" component={ParentLibrary} />
      <Stack.Screen name="ParentStoreFavoriteLinks" component={ParentStoreFavoriteLinks} />
      <Stack.Screen name="ParentAddLinks" component={ParentAddLinks} /> 
      <Stack.Screen name="ParentEditStoreFavoriteLinks" component={ParentEditStoreFavoriteLinks} /> 
      <Stack.Screen name="ParentViewStoreFavoriteLinks" component={ParentViewStoreFavoriteLinks} /> 
      ...
      <Stack.Screen name="ParentExportContent" component={ParentExportContent} />  
