...
export default function DeletePopup({cancelPress,deletePress}) {
  return (
    <View
    style={{
      position: "absolute",
  ...
  >
    <View style={{ width: "80%", backgroundColor: "#fff", padding: "6%" ,borderRadius:20}}>
      ...
      <View style={styles.button_container}>
        <View style={{width:'45%'}}>
        <AppButton title={"cancel"} btnColor={color.purple} onPress={cancelPress} /></View>
        <View style={{width:'45%'}}>
        <AppButton title={"Delete"} btnColor={color.purple} onPress={deletePress} /></View>
      </View>
    </View>
  </View>
  )
