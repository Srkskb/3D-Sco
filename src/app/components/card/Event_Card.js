...
export default function Event_Card({status,title,description,editPress,removePress,viewPress}) {
  return (
    ...
    <MaterialIcons name="arrow-forward-ios" size={20} color={color.purple} />
    </View>
      </View>
    ...
    <Text style={styles.description_text}>{description}</Text>
     ...
     {/* <View style={{ width: 10 }}></View> */}
      ...
      {/* <View style={{width:20}}></View> */}
      <Remove onPress={removePress}/></View>
    </View>
  );
}
