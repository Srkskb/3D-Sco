...
export default function ParentViewStoreFavoriteLinks({ route, navigation }) {
  ...
  return (
    <View style={styles.container}>
      <HeaderBack title={"My Project View"} onPress={() => navigation.navigate("ParentStoreFavoriteLinks")} />
