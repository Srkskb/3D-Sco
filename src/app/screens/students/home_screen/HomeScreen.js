      ...
      tabBarIcon: (tabInfo) => {
        return (
          <Ionicons
            name="md-home"
            size={24}
            color={tabInfo.focused ? color.purple : color.dark_gray}
          />
        );
      },
    },
  ...
  const navigationView = () => (
    <View style={[styles.container, styles.navigationContainer]}>
      ...
      <List.Item
        ...
        left={(props) => (
          <List.Icon {...props} icon="lock" color={color.purple} />
        )}
      ...
      <List.Item
        title="About Us"
        left={(props) => (
          <List.Icon {...props} icon="information" color={color.purple} />
        )}
      ...
      <List.Item
        ...
        left={(props) => (
          <List.Icon {...props} icon="map-marker-question" color={color.purple} />
        )}
      ...
      <List.Item
        ...
        left={(props) => (
          <List.Icon {...props} icon="note-text" color={color.purple} />
        )}
      ...
      <List.Item
        title="Contact Us"
        left={(props) => (
          <List.Icon {...props} icon="email" color={color.purple} />
        )}
      ...
      <List.Item
        title="Log Out"
        left={(props) => (
          <List.Icon {...props} icon="logout" color={color.purple} />
        )}
      ...
      <TouchableOpacity onPress={()=>(Linking.openURL(`http://www.facebook.com`))}>
        <Image
          ...
          source={require("../../../assets/images/social_icons/facebook.png")}
        />
        </TouchableOpacity>
        <TouchableOpacity onPress={()=>(Linking.openURL(`http://www.instagram.com`))}>
        <Image
          style={styles.social_icon}
          source={require("../../../assets/images/social_icons/instagram.png")}
        />
        </TouchableOpacity>
        <TouchableOpacity onPress={()=>(Linking.openURL(`http://www.twitter.com`))}>
        <Image
          style={styles.social_icon}
          source={require("../../../assets/images/social_icons/twitter.png")}
        />
        </TouchableOpacity>
        <TouchableOpacity onPress={()=>(Linking.openURL(`http://www.youtube.com`))}>
        <Image
          style={styles.social_icon}
          source={require("../../../assets/images/social_icons/youtube.png")}
        />
        </TouchableOpacity>
      </View>
    </View>
